...
//ORIGINAL CREDIT GOES TO: Barak Manos
//linkedin.com/in/barak-manos-3aa4361a

//SOURCE:
//raw.githubusercontent.com/bancorprotocol/contracts/master/solidity/contracts/converter/BancorFormula.sol
...
contract Formula {
    ...
    // ### THE ONLY ADDITION TO THIS FILE NOT INCLUDED BY ORIGINAL AUTHORS ###
    ...
    function calculateInterest(
        ...
        //principal = principal.mul(10**space); //for trailing digits, 18 precision as in HYDRO token
        //principal = principal.mul(10**18); 
        uint256 tmp = principal.mul(result) >> precision;
